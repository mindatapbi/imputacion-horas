...
const filtered = allIssues.filter((i: any) => i.issueType !== 'Epic' && !parentKeys.has(i.key)); setIssues(incluirFinalizadas ? filtered : filtered.filter((i: any) => i.parentStatusCategory !== 'done')); } setLoadingIssues(false); };
