...
const sinPadresIntermedios = allIssues.filter((i: any) => i.issueType !== 'Epic' && !parentKeys.has(i.key)); setIssues(incluirFinalizadas ? sinPadresIntermedios : sinPadresIntermedios.filter((i: any) => i.parentStatusCategory !== 'done')); } setLoadingIssues(false); };
